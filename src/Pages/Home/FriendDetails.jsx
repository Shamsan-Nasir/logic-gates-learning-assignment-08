...
export const FriendDetails = () => {
  ...
  return (
    <div className='bg-[#F8FAFC] px-10 sm:px-20 md:px-30 lg:px-49 py-16'>
      <button onClick={() => navigate(-1)} className='btn hover:bg-main hover:text-white'><FaArrowLeft></FaArrowLeft> Back</button>
          ...
          <div className='col-span-3 bg-white px-5 py-6 rounded-lg flex flex-col justify-center gap-3.5 flex-1 border border-[#E9E9E9]'>
            ...
            <div className='grid grid-cols-3 gap-5 border border-[#E9E9E9]'>
              <button onClick={() => {
                ...
                localStorage.setItem('timeline', JSON.stringify([...timelineCart, { 'name': requiredData.name, "time": dateTime, 'action': 'text' }]))
